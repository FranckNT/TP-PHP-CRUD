<?php $pdo = new PDO("mysql:host;dbname=CRUD", "root", ""); ?>
...
<head>
  ...
  <title>Display Franck Touko</title>
  <link rel="stylesheet" href"https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bpptstrap.min.css">
</head>

<body>

  <div class="container">
    <button class="btn btn-primary my-5"><a href="inscription.php" class="text-light">Ajouter un utilisateur</a></button>
